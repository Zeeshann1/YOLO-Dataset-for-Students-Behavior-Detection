...
def extract_frames(video_file):
    ...
    output_directory = "D:/All Videos latest20240814-xd/Images"
    ...
    while True:
        ...
        if frame_count % int(cap.get(5) / frame_rate) == 0:
            output_file = f"{output_directory}/frame_1{frame_count}.jpg"
...
if __name__ == "__main__":
    video_file = r"D:/All Videos latest20240814-xd/1.mp4"  # Replace with your video's name
