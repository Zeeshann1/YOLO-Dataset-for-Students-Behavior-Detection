...
def extract_frames(video_file):
    ...
    while True:
        ...
        if frame_count % int(cap.get(5) / frame_rate) == 0:
            output_file = f"{output_directory}/frame4_{frame_count}.jpg"
...
if __name__ == "__main__":
    video_file = r"/workspace/Videos  to Image code/modnet videos/4_fg.mp4"  # Replace with your video's name
